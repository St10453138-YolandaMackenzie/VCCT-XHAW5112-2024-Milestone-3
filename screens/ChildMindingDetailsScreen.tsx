...
type ChildMindingDetailsScreenProps = NativeStackScreenProps<RootStackParamList, 'ChildMinding'>;

const ChildMindingDetailsScreen: React.FC<ChildMindingDetailsScreenProps> = ({ navigation }) => {
...
<Text style={styles.courseDetailsTitle}>Details of Course</Text>
      ...
      <View style={styles.courseCard}>
        ...
        <Image 
          ...
          accessibilityLabel="Child Minding course header"
        />

        <Text style={styles.purpose}>To provide basic child and baby care</Text>
        ...
        <TouchableOpacity 
          ...
          accessibilityLabel="Register for the Child Minding course"
        >
...
export default ChildMindingDetailsScreen;
