...
type CookingDetailsScreenProps = NativeStackScreenProps<RootStackParamList, 'Cooking'>;

const CookingDetailsScreen: React.FC<CookingDetailsScreenProps> = ({ navigation }) => {
...
<Text style={styles.courseDetailsTitle}>Details of Course</Text>
      ...
      <View style={styles.courseCard}>
        ...
        <Image 
          ...
          accessibilityLabel="Cooking course header"
        />

        <Text style={styles.purpose}>To prepare and cook nutritious family meals</Text>
        ...
        <TouchableOpacity 
          ...
          accessibilityLabel="Register for the Cooking course"
        >
