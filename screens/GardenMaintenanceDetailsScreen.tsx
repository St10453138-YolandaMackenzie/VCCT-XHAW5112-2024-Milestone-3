...
type GardenMaintenanceDetailsScreenProps = NativeStackScreenProps<RootStackParamList, 'GardenMaintenance'>;
...
const GardenMaintenanceDetailsScreen: React.FC<GardenMaintenanceDetailsScreenProps> = ({ navigation }) => {
...
<Text style={styles.courseDetailsTitle}>Details of Course</Text>
      <View style={styles.courseCard}>
        ...
        <Image 
          source={require('../assets/garden_maintenance.png')} 
          style={styles.headerImage} 
          accessibilityLabel="Garden Maintenance course header"
        />
        ...
        <View style={styles.checkmarkSection}>
          <Text style={styles.checkmarkText}>✔️ Hands-on Learning</Text>
          <Text style={styles.checkmarkText}>✔️ Sustainable Practices</Text>
          <Text style={styles.checkmarkText}>✔️ Expert Guidance</Text>
          <Text style={styles.checkmarkText}>✔️ Up to 10% discount on three courses selection</Text>
        </View>

        <View style={styles.feeContainer}>
          <Text style={styles.fee}>R750</Text>
        </View>

        <TouchableOpacity 
          style={styles.registerButton} 
          onPress={handleRegister} 
          accessibilityLabel="Register for the Garden Maintenance course"
        >
