...
type SewingDetailsScreenProps = NativeStackScreenProps<RootStackParamList, 'Sewing'>;

const SewingDetailsScreen: React.FC<SewingDetailsScreenProps> = ({ navigation }) => {
...
<Text style={styles.courseDetailsTitle}>Details of Course</Text>
      ...
      <View style={styles.courseCard}>
        ...
        <Image 
          ...
          accessibilityLabel="Sewing course header"
        />
       
        <Text style={styles.purpose}>To provide alterations and new garment tailoring services</Text>
        ...
        <TouchableOpacity 
          ...
          accessibilityLabel="Register for the Sewing course"
        >
