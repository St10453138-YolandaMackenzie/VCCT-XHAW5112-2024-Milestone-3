...
type ShortCoursesScreenProps = NativeStackScreenProps<RootStackParamList, 'ShortCourses'>;

export default function ShortCoursesScreen({ navigation }: ShortCoursesScreenProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.headerTitle}>Short-Term Courses</Text>

      <Button title="Child Minding" navigateTo="ChildMinding" color="blue" />
      <Button title="Cooking" navigateTo="Cooking" color="purple" />
      <Button title="Garden Maintenance" navigateTo="GardenMaintenance" color="#8B4513" />
      
      <TouchableOpacity style={styles.bottomButton} onPress={() => handleNavigation('LongCourses')}>
        <Text style={styles.bottomButtonText}>Six months courses</Text>
      </TouchableOpacity>
